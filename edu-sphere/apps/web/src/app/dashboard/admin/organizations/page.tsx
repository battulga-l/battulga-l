    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Organizations Management</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Manage all organizations in the system</p>
          </div>
          <Link
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {organizations.map((org) => (
                    <tr key={org.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                        {org._count.users} users • {org._count.courses} courses • {org._count.classes} classes
                      </td>
